...
<aside id="slide-out" class="side-nav white fixed">
    ...
    <ul class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion" style="">
        <li>&nbsp;</li>
        <li class="no-padding"><a class="waves-effect waves-black" href="index.php"><i class="material-icons">account_box</i>Employe Login</a></li>
        <li class="no-padding"><a class="waves-effect waves-black" href="forgot-password.php"><i class="material-icons">account_box</i>Emp Password Recovery</a></li>
    
            <li class="no-padding"><a class="waves-effect waves-black" href="admin/"><i class="material-icons">account_box</i>Admin Login</a></li>
        ...
        <div class="row">
            <form class="col s12" name="signin" method="post">
                ...
                <div class="col s12 right-align m-t-sm">
                    ...
                    <input type="submit" name="signin" value="Sign in" class="waves-effect waves-light white">
                </div>
            </form>
        </div>
    </div>
